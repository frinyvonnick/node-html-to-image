...
| beforeRendering   | An async function that will execute before the HTML is set on the page (before `setContent`). Gives access to the puppeteer page, e.g. to intercept requests or set the viewport.                                       | Function                                        | optional |
